...
- 2025 INFORMS Quality, Statistics and Reliability Section Best Student Paper 
...
<div style="display: flex; align-items: flex-start; margin-bottom: 2em;">
  ...
  <div>
    ...
    <ul style="list-style-type: circle; margin-top: 4px;">
      ...
      <li>Preliminary <a href="https://openreview.net/pdf?id=0ZALcXRKAc" target="_blank">version</a> appeared in 
<em>The First Structured Knowledge for Large Language Models Workshop (KDD 2025)</em>
</li>
</ul>
</div>
  ...
  <div>
    ...
    <ul style="list-style-type: circle; margin-top: 4px;">
      ...
      <li style="list-style-type: none; margin-left: -1em; display: flex; align-items: flex-start;">
        ...
        <span style="color: #b30000;">2025 INFORMS Quality, Statistics and Reliability Section Student Paper Competition 1st Place.</span>
      </li>
    </ul>
  </div>
